...
def conv_gru_input_model(input_list,input_kernels,input_kernel_width,leakyrelu_alpha):
    ...
    # conv_3 = layers.Conv1D(input_kernels*6, input_kernel_width, padding='same', strides=2,
    ...
    # rnn_3 = layers.GRU(input_kernels*6,return_sequences=True,activation='tanh')(conv_3)
