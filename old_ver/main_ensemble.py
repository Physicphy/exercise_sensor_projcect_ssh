...
from my_model_ensemble import make_CNN_RNN_model
...
checkpoint_filepath = './save/cnn_gru_ensemble_best.hdf5'
...
model = make_CNN_RNN_model(
    lr = 0.001,
    leakyrelu_alpha = 0.1, # #-0.1#, #0.05#, #0.1#, 0.2
...
model.summary()
# %%
lr_scheduler = tf.keras.callbacks.ReduceLROnPlateau(patience = 15,verbose = 1,factor = 0.5) 
