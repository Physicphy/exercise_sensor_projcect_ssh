...
def conv_block(x,kernels,width,regularize_coeff,leakyrelu_alpha):
    ...
    # x= layers.Activation(tfa.activations.lisht)(x)
    #x = layers.ELU()(x)
...
def conv_gru_input_model(input_list,input_kernels,input_kernel_width,leakyrelu_alpha):
    ...
    # conv_1 = layers.Activation(tfa.activations.lisht)(conv_1)
    ...
    # rnn_1 = layers.Activation(tfa.activations.lisht)(rnn_1)
    ...
    # conv_2 = layers.Activation(tfa.activations.lisht)(conv_2)
    ...
    # rnn_2 = layers.Activation(tfa.activations.lisht)(rnn_2)
...
def make_CNN_RNN_model(
    ...
    diff_model = conv_gru_input_model(diff_input_list,input_kernels,input_kernel_width,leakyrelu_alpha)
    ...
    add_layers = layers.Add()([model_1.output,model_2.output,model_3.output])
    add_layers = layers.Dense(61,activation='softmax',
                    kernel_initializer=initializers.he_uniform(seed=42))(add_layers)
