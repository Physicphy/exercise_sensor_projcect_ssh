...
class CNN_RNN_Resnet:
    ...
    def conv_gru_input_model(self,input_list,input_kernels,input_kernel_width,regularize_coeff,leakyrelu_alpha):
        ...
        conv_2 = self._conv(input_kernels*2, input_kernel_width*3, padding='same', strides=2,
                            kernel_regularizer=self._regularizer(regularize_coeff),
        ...
        rnn_2 = self._rnn(input_kernels*4,return_sequences=True,
                        kernel_regularizer=self._regularizer(regularize_coeff),
        ...
        conv_3 = self._conv(input_kernels*4, input_kernel_width*2, padding='same', strides=2,
                            kernel_regularizer=self._regularizer(regularize_coeff),
        ...
        conv_model = Model(input_list, rnn_4)
        return conv_model
